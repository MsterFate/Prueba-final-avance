...
function CreacionEspecialistas() {
    ...
    const refreshList = () => {
        axios.get('http://localhost:8000/api/especialistas/')
    ...
    const handleSubmit = (item) => {
        toggle();
        const apiUrl = item.id ? `http://localhost:8000/api/especialistas/${item.id}/` : 'http://localhost:8000/api/especialistas/';
